    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBtnOk.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                String mInputMoneyStr = mInputMoney.getText().toString();
                String mInputInfoStr = mInputInfo.getText().toString();
                Toast.makeText(PaymentActivity.this,   mInputMoneyStr + " $ переведено на " + mInputInfoStr,Toast.LENGTH_LONG).show();
            }
        });
